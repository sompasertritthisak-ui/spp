...
export function Testimonials({ items }: { items: Testimonial[] }) {
  ...
  return (
    <section aria-labelledby="voices-title" className="border-t border-ink-700 bg-ink-900">
      <div className="shell py-20 lg:py-32">
        ...
        <ul className="border-b border-ink-600">
          {items.slice(0, 3).map((t) => (
            <li key={`${t.name}-${t.company}`} className="grid gap-x-16 gap-y-5 border-t border-ink-600 py-10 lg:grid-cols-12 lg:py-14">
              <blockquote className="t-title text-fog-50 lg:col-span-8">“{t.quote}”</blockquote>
