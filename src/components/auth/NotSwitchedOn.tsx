...
export function NotSwitchedOn({ contact }: { contact: AuthContact }) {
  return (
    <div className="flex flex-col gap-6">
      <h1 className="t-title text-fog-50">Accounts are not switched on yet.</h1>
      ...
      <p className="text-fog-400">You can still start a project today. We reply to every request personally.</p>
